...
Menu::Menu(QWidget *parent) : QWidget(parent), isAdminLoggedIn(false) {
    ...
    allBooks = {
        Book("Harry Potter and the Philosopher's Stone", "J.K. Rowling", 1997, true, 5),
        Book("To Kill a Mockingbird", "Harper Lee", 1960, true, 1),
        Book("The Great Gatsby", "F. Scott Fitzgerald", 1925, false, 0)
    };
